...
const textView1 = `[green]func[white] [yellow]main[white]() {
    ...
    textView := view.[yellow]NewTextView[white]().
...
func TextView1(nextSlide func()) (title string, info string, content view.Primitive) {
	textView := view.NewTextView()
	textView.SetVerticalAlign(view.AlignBottom)
...
[green]func[white] [yellow]main[white]() {
    ["0"]textView[""] := view.[yellow]NewTextView[white]()
...
func TextView2(nextSlide func()) (title string, info string, content view.Primitive) {
	...
	textView.SetScrollBarVisibility(view.ScrollBarAuto)
