/*
A presentation of the view package, implemented with view.
...
type Slide func(nextSlide func()) (title string, info string, content view.Primitive)

// The application.
var app = view.NewApplication()
...
func main() {
	...
	for index, slide := range slides {
		...
		if info != "" {
			...
			h.SetText("  [" + view.ColorHex(view.Styles.SecondaryTextColor) + "]Info:[-]  " + info)
		}

		// Create a Flex layout that centers the logo and subtitle.
		f := view.NewFlex()
		f.SetDirection(view.FlexRow)
